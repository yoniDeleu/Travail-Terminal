from carte_eleve import * # A completer
    ...
    if res == -1 :
        ...
        if f1 >=3 and  f2 >=3 : #A compléter
            ...
            if f1 or f2 < 3 : # A compléter
                while not f1.est_vide():#A completer 
                    f1.defile()#A completer
            else :
                while not f2.est_vide():#A completer 
                    f2.defile()#A completer
...
def bataille(c1,c2,f1,f2) :
    ...
    bataille_tab= []
    while comp(c1,c2) == 0:
        bataille_tab.append(c1)#Completer
